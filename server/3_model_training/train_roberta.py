# Fine-tune RoBERTa for Emotion Classification
...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained('ml_models/roberta')
    model = AutoModelForSequenceClassification.from_pretrained('ml_models/roberta', num_labels=5, id2label={v:k for k,v in label_dict.items()}, label2id=label_dict)
    model.to(device)
    print('Model loaded\\n')
    ...
    visualizer = ComprehensiveVisualizer('RoBERTa Fine-tuned', results_dir, emotion_labels)
