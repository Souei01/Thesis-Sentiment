...
def generate_feedback_report_pdf(feedback_qs, filters, user):
    ...
    user_identifier = user.email if hasattr(user, 'email') and user.email else f"{user.first_name} {user.last_name}"
    
    metadata = [
        ['Report Generated:', timestamp],
        ['Generated By:', user_identifier],
        ['Department:', getattr(user, 'department', None) or 'All Departments'],
    ]
    ...
    elements.append(Paragraph("AI-Powered Sentiment Analysis", heading_style))
    ...
    if total_emotions > 0:
        ...
        elements.append(Paragraph("Student Feedback Highlights", heading_style))
